...
Solution Explorer provides access to various user interfaces available in the cluster.
Red Hat recommends that new users perform the Solution Patterns, available from the *All Solution Patterns* tab, to develop a better understanding of the capabilities of a {PRODUCT_SHORT} cluster.
...
* Edit a 3scale product and backend
