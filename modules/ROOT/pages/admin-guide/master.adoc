...
[id="admin-guide"]
= Administering {PRODUCT} {PRODUCT_VERSION}
...
You can navigate to the {customer-sso-name} from the *Protect customer applications* item in the {webapp}.
...
. Navigate to the {customer-sso-name} from the *Protect customer applications* item in the {webapp}.
...
// include::modules/admin-guide/proc_disabling-communications.adoc[leveloffset=+2]
...
You can navigate to the 3scale console from the *Manage APIs* item in the {webapp}.
