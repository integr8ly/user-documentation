...
Red Hat manages this instance; however, the customer-admin user has administrator level privileges to configure this instance.
...
A user named `admin` is also created and is used to manage the instance. Do not delete this user.
