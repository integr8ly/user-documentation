...
----
+
. Set up your public base URL in APIcast as described in the link:{three-scale-docs}/html/administering_the_api_gateway/operating-apicast[3scale documentation].


.Additional resources

* See the link:{three-scale-docs}/html-single/administering_the_api_gateway/index#public_base_url[Public Base URL] documentation for an introduction to custom URLs.
