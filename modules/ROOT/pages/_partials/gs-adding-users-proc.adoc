...
NOTE: The `customer-admin` user is a single account with the privilege to create users in your Managed Integration cluster. If you require more users with the same privileges, contact link:https://access.redhat.com/support[Red Hat Support].
