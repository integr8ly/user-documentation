...
Note: You can access the GitHub repository that contains the {walkthrough-name} source code, by clicking the *Repository* link located in the upper right corner of the *All Solutions Patterns* tab in the Solution Explorer.
