...
The following middlware products are available as part of {PRODUCT_SHORT}:

* Fuse Online
* AMQ Online
* 3scale

The Solution Explorer provides navigatation to these products and others, including the OpenShift console. The Solution Explorer also provides walkthroughs that guide you through the process of creating an integration solution using these products.
