...
Try downloading the link:https://github.com/integr8ly/walkthrough-template/archive/master.zip[zip] file and creating a repository
.
////
...
{
  "dependencies": {
    "/Users/bdooley/Documents/code/user-documentations": [],
    "serviceInstances": []
  }
}
----

=== Committing your {walkthrough-name}s to a remote /Users/bdooley/Documents/code/user-documentationsitory

Typically, you edit the `walkthrough.adoc` file and push your changes to GitHub.

. Create a new remote /Users/bdooley/Documents/code/user-documentationsitory and take note of the remote URL
...
////
[type=verification]
Make sure you have a remote /Users/bdooley/Documents/code/user-documentationsitory with the content you want to publish.
...
* You have added the {walkthrough-name} repository to your cluster as described in the {publishing-walkthrough} {walkthrough-name}.
...
By default, the walkthroughs from a repository are displayed in Solution Explorer with a title corresponding to your repository name. However, you can add a `walkthroughs-config.json` file with the following contents if, for example, you want to title the group `My Walkthroughs`:
