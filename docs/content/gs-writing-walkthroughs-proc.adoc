...
<2> The first line of the introduction is displayed as a tag line for the {walkthrough-name}.  Please note that attributes will not be rendered in this tag line.
